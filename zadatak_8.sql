# c:\xampp\mysql\bin\mysql -uroot < C:\Users\AMD\AppData\Roaming\DBeaverData\workspace6\General\Scripts\zadatak_8.sql

drop database if exists zadatak_8;
create database zadatak_8;
use zadatak_8;
